...
<div id="app" class="hide"><div class="wrap">
  ...
  <div class="view" data-v="sched">
    <p class="hint" style="margin:0 0 14px">Единое место для всех уведомлений. Каждая карточка показывает главное сразу: иконку и название, триггер (<b>🔔 вебхук</b> — в реальном времени по событию GitLab, <b>⏱ расписание</b> — по дням/времени или интервалу), адрес (Комната / Личка), выключатель и строку «когда» (напр. «Пн–Пт · 09:00»). Детали — расписание и адрес — прячутся под «⚙ Настроить». Карточка <b>issue</b> (открытие/закрытие) приходит вебхуком — у неё нет расписания и «Запустить сейчас». Дайджесты разделены на «полный» (полная сводка) и «изменения» (дельта со вчера) — это отдельные рассылки со своим расписанием, но <b>один тип</b> (выключатель и адрес общие). Сгруппировано вкладками ниже: <b>Групповые</b> → в комнату, <b>Личные</b> → в ЛС, <b>Вебхуки</b> → события в реальном времени.</p>
