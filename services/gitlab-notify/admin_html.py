    ...
    <details class="ref"><summary>📖 Справка: кнопки запуска и режимы</summary>
      <div class="refbody">
        ...
        <ul class="reflist">
          ...
          <li><b>▶ Отправить изменения</b> / <b>▶ Отправить всё</b> (у дайджестов) — реально шлёт: «изменения» = только что поменялось со вчера (дельта), «всё» = полная сводка (как в якорный день). Можно жать сколько угодно — шлёт каждый раз.</li>
          <li><b>▶ Запустить сейчас</b> (у остальных рассылок) — реально отправить эту рассылку прямо сейчас.</li>
        </ul>
