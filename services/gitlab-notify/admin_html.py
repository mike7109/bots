...
<div id="app" class="hide"><div class="wrap">
  ...
  <div class="view" data-v="sched">
    <p class="hint" style="margin:0 0 14px">Каждая рассылка: что делает, когда бот её шлёт (дни + время — планирует сам, host-cron не нужен) и кнопка «запустить сейчас». Дайджесты разделены на «полный» (полная сводка) и «изменения» (дельта со вчера) — это отдельные рассылки со своим расписанием. Рассылки сгруппированы по теме: <b>Групповые</b> уходят в общую комнату, <b>Личные</b> — в ЛС исполнителю. Переключайтесь вкладками ниже.</p>
